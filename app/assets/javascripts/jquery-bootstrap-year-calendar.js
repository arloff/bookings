...
* https://www.jqueryscript.net/time-clock/Year-Calendar-Bootstrap-4.html
...
(function ($) {
    ...
    function addRagepickerClassBetweenDays(addClass) {
      ...
      endMonth = endDay[1];
      endDay = endDay[0];
      addMarker(addClass,startYear, startMonth, startDay, endYear, endMonth, endDay);
    }
    function addMarker(addClass,startYear, startMonth, startDay, endYear, endMonth, endDay) {
